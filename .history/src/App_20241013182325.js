...
import { BrowserRouter as Router, Route, Routes, Navigate } from 'react-router-dom'; // Removido o uso de `useLocation`
    ...
    <Router>
      <div>
        ...
        <Routes>
          ...
          <Route 
            path="/" 
            element={!isAuthenticated ? <Login onLogin={handleLogin} /> : <Navigate to="/cadastro" />} // Se autenticado, exibe a página de Cadastro
          />

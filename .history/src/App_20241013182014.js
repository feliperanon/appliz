...
const App = () => {
  ...
  return (
    <Router>
      <div>
        {/* Navbar só aparece quando o usuário está autenticado */}
        ...
        <Routes>
          ...
          <Route 
            path="/" 
            element={!isAuthenticated ? <Login onLogin={handleLogin} /> : <Navigate to={location.pathname} />}  // Mantém o caminho atual ao logar
          />

...
const CadastroEquipamento = () => {
  const [formData, setFormData] = useState({
    ...
    numeroFrota: '',
    marca: '',
    kmHorimetro: '',  // Unificado em um só campo
  });
      ...
      <Row className="justify-content-center">
        <Col md={6}>
          ...
          <Form onSubmit={handleSubmit}>
            ...
            {showKmHorimetroField() && (
              <Form.Group className="mb-3">
                <Form.Label>KM/Horímetro</Form.Label>
                <Form.Control
                  type="number"
                  name="kmHorimetro"
                  value={formData.kmHorimetro}
                  onChange={handleChange}
                  placeholder="Digite a quilometragem ou horímetro"
                />
              </Form.Group>
            )}

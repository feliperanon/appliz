...
import { FaHome, FaClock, FaChartLine, FaClipboardList, FaCheckCircle, FaChalkboardTeacher, FaTools, FaRecycle } from 'react-icons/fa';

const NavigationBar = () => {
  return (
    <>
      <Navbar style={{ backgroundColor: '#282832' }} variant="dark" expand="lg" className="mb-3">
        <Container fluid>

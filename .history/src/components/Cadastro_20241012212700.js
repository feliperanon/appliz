...
import { LoadScript, Autocomplete } from '@react-google-maps/api'; // Google Maps Autocomplete
...
const Cadastro = () => {
  ...
  // Renderização dos campos específicos para cada tipo de equipamento
        ...
        return (
          <>
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" name="combustivel" value="Gás" readOnly />
            </Form.Group>
            <Form.Group className="mb-3">
              <Form.Label>Capacidade de Carga</Form.Label>
              <Form.Control type="text" name="capacidadeCarga" onChange={handleChange} />
            </Form.Group>
            <Form.Group className="mb-3">
              <Form.Label>Capacidade de Elevação</Form.Label>
              <Form.Control type="text" name="capacidadeElevacao" onChange={handleChange} />
            </Form.Group>
            <Form.Group className="mb-3">
              <Form.Label>Tipo de Pneu</Form.Label>
              <Form.Control type="text" name="tipoPneu" onChange={handleChange} />
            </Form.Group>
          </>
        );
        ...
        return (
          <>
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" name="capacidadeBateria" onChange={handleChange} />
            </Form.Group>
            <Form.Group className="mb-3">
              <Form.Label>Tempo Médio de Recarga</Form.Label>
              <Form.Control type="text" name="tempoRecarga" onChange={handleChange} />
            </Form.Group>
            <Form.Group className="mb-3">
              <Form.Label>Capacidade de Carga</Form.Label>
              <Form.Control type="text" name="capacidadeCarga" onChange={handleChange} />
            ...
            <Form.Group className="mb-3">
              <Form.Label>Leitura de Horímetro</Form.Label>
              <Form.Control type="text" name="horimetro" value={formData.horimetro} onChange={handleChange} />
            </Form.Group>
          </>
        );
      case 'Caminhão':
        return (
          <>
            <Form.Group className="mb-3">
              <Form.Label>Tipo de Combustível</Form.Label>
              <Form.Control type="text" name="combustivel" onChange={handleChange} />
            </Form.Group>
            <Form.Group className="mb-3">
              <Form.Label>Capacidade de Carga</Form.Label>
              <Form.Control type="text" name="capacidadeCarga" onChange={handleChange} />
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" name="placa" onChange={handleChange} />
            </Form.Group>
            <Form.Group className="mb-3">
              <Form.Label>KM Rodado</Form.Label>
              <Form.Control type="text" name="km" onChange={handleChange} />
            </Form.Group>
          </>
        );
      case 'Carro':
        ...
        return (
          <>
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" name="tipoPaleteira" onChange={handleChange} />
            </Form.Group>
            <Form.Group className="mb-3">
              <Form.Label>Capacidade de Carga</Form.Label>
              <Form.Control type="text" name="capacidadeCarga" onChange={handleChange} />
            ...
            <Form.Group className="mb-3">
              <Form.Label>Tamanho dos Garfos</Form.Label>
              <Form.Control type="text" name="tamanhoGarfos" onChange={handleChange} />
            </Form.Group>
          </>
        );
      case 'Carrinho de Madeira':
        return (
          <>
            <Form.Group className="mb-3">
              <Form.Label>Número do Carrinho</Form.Label>
            ...
            <Form.Group className="mb-3">
              <Form.Label>Condição Atual</Form.Label>
              <Form.Control type="text" name="condicaoAtual" onChange={handleChange} />
            </Form.Group>
            <Form.Group className="mb-3">
              <Form.Label>Uso Atual</Form.Label>
              <Form.Control type="text" name="usoAtual" onChange={handleChange} />
            </Form.Group>
          </>
        );
      default:
        ...
        <Form onSubmit={handleSubmit}>
          ...
          {userType === 'equipamento' && (
            <>
              ...
              {/* Renderização dos campos específicos do equipamento */}
              {renderEquipmentFields()}

              {/* Exibir campos de KM e Horímetro somente para os tipos que exigem */}
              {requiresKmHorimetro() && (
                <>
                  <Form.Group className="mb-3">

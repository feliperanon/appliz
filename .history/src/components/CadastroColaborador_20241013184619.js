              ...
              <tbody>
                {colaboradores.map((colaborador) => (
                  <tr key={colaborador._id}>
                    ...
                    <td>
                      <Button className="custom-btn-edit btn-sm" onClick={() => handleEdit(colaborador)}>Editar</Button>{' '}
                      <Button className="custom-btn-delete btn-sm" onClick={() => handleDelete(colaborador._id)}>Excluir</Button>
                    </td>
                  </tr>
                ))}
              </tbody>
